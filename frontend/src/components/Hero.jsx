      ...
      >
        <div className="grid w-full items-end gap-16 lg:grid-cols-12">
          ...
          <div className="max-w-2xl lg:col-span-7">
            ...
            >
              Un Plan Personal de Retiro que crece con interés compuesto, deduce
              impuestos desde el primer día y te da la libertad de vivir mañana
              como lo sueñas hoy.
            </motion.span>
          ...
          >
            <div className="mb-8">
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#3D1A4E]">
                Da el primer paso
              </p>
              ...
              <p className="mt-2 font-thin text-sm leading-relaxed text-gray-300">
            ...
            <div className="mt-6 grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-2xl border border-input bg-transparent px-3 text-sm outline-none focus:border-[#3D1A4E]"
              >
                {INTERESTS.map((i) => (
            ...
            <div className="mt-6 grid gap-2">
              ...
              <Textarea
                ...
                className="min-h-28 rounded-2xl border border-input bg-transparent px-3 py-2 text-sm outline-none focus:border-[#3D1A4E]"
              />
            </div>
