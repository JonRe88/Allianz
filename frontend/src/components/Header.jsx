...
export const Header = ({ onAgenda }) => (
  ...
  >
    <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
      <Link to="/" data-testid="header-logo-link" className="group flex items-baseline gap-2">
        <span className="font-serif text-xl font-bold tracking-tight text-[#003781] transition-colors group-hover:text-[#00255A]">
          XIMNANZAS
        </span>
        <span className="hidden text-[11px] font-medium uppercase tracking-[0.2em] text-neutral-500 sm:inline">
          Asesor Allianz
        </span>
      </Link>
