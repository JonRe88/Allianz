...
export const ServicesGrid = () => (
  <section id="servicios" data-testid="services-section" className="bg-[#FAFAFA] py-24 lg:py-32">
    <div className="mx-auto max-w-7xl px-6 lg:px-10">
      ...
      >
        <div>
          <p className="mb-6 text-xs font-semibold uppercase tracking-[0.3em] text-[#003781]">Otros servicios</p>
        ...
        {PRODUCT_LIST.map((p, i) => (
          ...
          >
            <Link
              ...
              className="group relative flex h-full flex-col justify-between overflow-hidden bg-white p-10 transition-colors duration-500 hover:bg-[#003781] lg:p-14"
            >
              <div className="flex items-start justify-between">
                <span className="font-serif text-5xl font-light text-[#003781]/15 transition-colors duration-500 group-hover:text-white/25">
                  {p.chapter}
                </span>
                <ArrowUpRight className="h-6 w-6 text-[#003781] transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-white" />
              </div>
              <div className="mt-16">
