...
export default function WhatsAppFloat() {
  return (
    <motion.a
      href="https://wa.me/525951069096?text=Hola%20XIMNANZAS%2C%20quiero%20informes%20del%20PPR%20Allianz"
      target="_blank"
    ...
    >
      ...
      <span className="relative flex w-14 h-14 rounded-full bg-brand-blue shadow-inner-lg shadow-brand-gold/40 items-center justify-center">
